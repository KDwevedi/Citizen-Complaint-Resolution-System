...
dc5ae65d-5793-46a6-beaa-4d64c045312b	pg	d6edbe81822577c3aeda256dce21329f9b051c980f7fd7f3f9b6c55df9840eb4	ACCESSCONTROL-ACTIONS-TEST.actions-test	{"id":2513,"url":"/mdms-v2/v2/_search","code":"null","name":"MDMS v2 (search v2)","path":"","enabled":true,"displayName":"MDMS v2","orderNumber":1,"serviceCode":"MDMS v2","parentModule":"","resource":{"masters":{"ACCESSCONTROL-ROLES.roles":{"condition":{"in":["MDMS_ADMIN",{"var":"user.roles"}]}},"ACCESSCONTROL-ACTIONS-TEST.actions-test":{"condition":{"in":["MDMS_ADMIN",{"var":"user.roles"}]}},"ACCESSCONTROL-ROLEACTIONS.roleactions":{"condition":{"in":["MDMS_ADMIN",{"var":"user.roles"}]}},"common-masters.Department":{"condition":{"or":[{"in":["MDMS_ADMIN",{"var":"user.roles"}]},{"in":["SUPERVISOR",{"var":"user.roles"}]}]}}}}}	t	system-mdms-seed	system-mdms-seed	1766039437780	1766039437780
...
89e82efb-c5b2-45bd-a1ad-657d33fb6882	pg	09124d06961e5b657a9813fc586486be1013b693af0e6c0ec856da1c7c247e88	ACCESSCONTROL-ACTIONS-TEST.actions-test	{"id":2008,"url":"/pgr-services/v2/request/_search","code":"null","name":"Search PGR Request","path":"","enabled":false,"displayName":"Search PGR Request","orderNumber":0,"serviceCode":"pgr-services","parentModule":"","method":"POST","resource":{"complaint":{"attributes":{"citizen.mobileNumber":{"condition":{"or":[{"==":[{"var":"user.attributes.tenantWide"},true]},{"==":[{"var":"resource.complaint.accountId"},{"var":"user.uuid"}]}]},"onDeny":{"strategy":"MASK_SHOW_LAST_N","n":2,"maskChar":"X"}}}}},"condition":{"or":[{"==":[{"var":"user.attributes.tenantWide"},true]},{"and":[{"==":[{"var":"user.type"},"CITIZEN"]},{"==":[{"var":"resource.complaint.accountId"},{"var":"user.uuid"}]}]},{"and":[{"==":[{"var":"user.type"},"EMPLOYEE"]},{"in":[{"var":"resource.complaint.department"},{"var":"user.attributes.departments"}]},{"in":[{"var":"resource.complaint.boundary"},{"var":"user.attributes.jurisdictions"}]}]}]}}	t	system-mdms-seed	system-mdms-seed	1766039437780	1766039437780
...
accesscontrol-roleaction-2008-pgrviewer	pg	PGR_VIEWER.2008	ACCESSCONTROL-ROLEACTIONS.roleactions	{"actionid": 2008, "rolecode": "PGR_VIEWER", "tenantId": "pg", "actioncode": ""}	t	system-mdms-seed	system-mdms-seed	1785200000000	1785200000000
\.
